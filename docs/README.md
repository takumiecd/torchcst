...
- [optimizer-selection.ja.md](optimizer-selection.ja.md) — current Triweight + Polar + Quadratic recommendation, fixed-LR best practices, and staged optimizer deletion candidates;
