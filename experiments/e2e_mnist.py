...
def load_mnist(
    ...
    *,
    ...
    """Load configurable prefixes while preserving the original E2E defaults."""
    train_x = _parse_images(data_dir / "train-images-idx3-ubyte", train_limit)
    train_y = _parse_labels(data_dir / "train-labels-idx1-ubyte", train_limit)
    test_x = _parse_images(data_dir / "t10k-images-idx3-ubyte", test_limit)
    test_y = _parse_labels(data_dir / "t10k-labels-idx1-ubyte", test_limit)
