...
from experiments.local_first_moment import solve_blocks
from torchcst._runtime.validation import require
from torchcst.optim.solvers.quartic import QuarticSolveResult


def solve(metric, linear, lr, damping):
    displacement, _relative, valid = solve_blocks(metric, -lr * linear, damping)
