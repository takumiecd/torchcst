...
from cstf.storage import SynapseBirth, SynapseDeath, SynapseMerge
...
class ProfitCourt:
    ...
    def state_dict(self) -> dict[str, str]:
        ...
        return {"schema": "cstf-profit-court-v1"}

    def load_state_dict(self, state: Mapping[str, object]) -> None:
        if not isinstance(state, Mapping) or state.get("schema") != "cstf-profit-court-v1":
