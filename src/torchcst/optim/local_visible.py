"""Atom-local optimizer for projected visible diagonal-Adam evidence."""

from torchcst._derivatives.local_tangent import AtomLocalTangentGeometry

from ._regularized_update import solve
from .config import LocalVisibleAdamConfig
from .first_order import _TangentModelOptimizer
from .moments import MomentSystem
from .moments.projected_visible import ProjectedVisibleSecondMoment
from .moments.tangent import TangentFirstMoment


class CSTLocalVisibleAdam(_TangentModelOptimizer):
    """Transport compact visible vector/operator representatives per atom."""

    config_type = LocalVisibleAdamConfig
    ...
    def _make_moments(self):
        ...
        return MomentSystem(
            ...
            second=ProjectedVisibleSecondMoment(
                c.betas[1],
                eps=c.eps,
                damping=c.second_moment_damping,
                rtol=c.solve_rtol,
            ),
        )
    ...
    def _moment_contract(self):
        ...
        return {
            ...
            "second_moment_damping": c.second_moment_damping,
            "update_damping": c.update_damping,
            "second_moment": "projected_visible_diagonal_operator",
        }
